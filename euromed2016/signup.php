...
<?php logged_in_redirect(); 	// User can't access the page if he is logged in. Redirect to index.php?>	
...
if (empty($_POST) === false) {
	$required_fields = array('first_name', 'surname', 'username', 'password' , 're-enter_password' , 'email');
...
if(isset($_GET['success']) && empty($_GET['success'])) {
	echo '<span style="color: green;">You \'ve successfully signed up!</span><br>';
...
?></center>
	...
	<p style="text-align: center;"><b>New to our site? Create an account for many cool features!</b></p><br>
